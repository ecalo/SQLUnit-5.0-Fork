/*
 * $Id: ClobType.java,v 1.9 2004/09/30 17:27:55 spal Exp $
 * $Source: /cvsroot/sqlunit/sqlunit/src/net/sourceforge/sqlunit/types/ClobType.java,v $
 ...
 * @sqlunit.type name="ClobType" input="No" output="Yes" sortable="No"
 *  wraps="java.sql.Clob"
 * @sqlunit.typename name="CLOB" server="Any"
 * @sqlunit.typename name="LONGVARCHAR" server="MySQL"
 */
public class ClobType extends UnsupportedType {
    ...
    protected String format(final Object obj) throws SQLUnitException {
        ...
        Clob clob = (Clob) obj;
        try {
            byte[] bb = clob.getSubString(1, (int) clob.length()).getBytes();
